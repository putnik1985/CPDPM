           ...
           if ($0 ~ /SUBCASE ID/){
			   ...
			   if ($4 == type["cbush"]){
			       while(readline() && $0 !~ /TITLE/){
                         ...
                         stress[id] = vm
                         tensile_stress[id] = abs(fx) / A
                         bending_stress[id] = bending * ymax / Jd  						 
								   ...
								   printf("%d%12.2f%12.2f%12d\n", case_number, tensile_stress[elem] * 1.45038E-7, bending_stress[elem] * 1.45038E-7,elem)
			   }
		    }
	}
